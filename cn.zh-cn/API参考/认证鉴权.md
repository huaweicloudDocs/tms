# 认证鉴权<a name="zh-cn_topic_0173938834"></a>
...
调用本服务API需要全局级别的Token，即调用[获取用户Token](https://support.huaweicloud.com/api-iam/iam_30_0001.html)接口时，请求body中**auth.scope**的取值需要选择**domain**，如下所示。
